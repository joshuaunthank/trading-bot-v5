	...
	return (
		<div className="p-4 border rounded-lg bg-gray-100 dark:bg-gray-800">
			...
			<div className="mt-4 text-xs text-gray-600">
				<p>
					<strong>Connection:</strong> Real-time market data streaming via
					WebSocket connection to ensure up-to-date pricing information.
				</p>
				<p>
					<strong>Reliability:</strong> Automatic fallback to REST API polling
